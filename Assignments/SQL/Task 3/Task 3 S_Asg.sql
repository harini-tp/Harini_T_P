...
--1 total payment made by a specific student
...
--2 retrieve a list of courses with the count of students enrolled in each 
...
--4 student names and the courses they are enrolled in
...
--5 tried concatenate to display the names together
...
--6 list the name of teachers and courses they are assigned
...
--7 list of students and enrollment date for a course
...
--8 list of students who has made no payment
...
--10 students enrolled in more than one course
...
--11 teacher with no assigned courses
